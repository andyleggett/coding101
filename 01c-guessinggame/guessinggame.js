...
do {
    ...
    if (guess == mysteryNumber) {
        console.log('You guessed the mystery number ' + mysteryNumber + ' correctly with ' + triesRemaining + ' tries remaining');
    } else {
        console.log('Incorrect - you have ' + triesRemaining + ' tries remaining');
    }
